...
window.addEventListener("DOMContentLoaded", () => {
  ...
  let hcode = `
    ...
    <a href="#" class="fi fi-person" title="회원가입">
  ...
  $(".sns a").click(function (e) {
    ...
    // window.open() 새창열기 -> 원래는 팝업창 띄우는 것  
  ...
  /***************************************** 
    [ HTML컬렉션에서 forEach 메서드 사용하기 ]
    -> 원래 배열에서 사용되는 forEach가 유명함!

    컬렉션변수.forEach((요소자신,요소순번)=>{코드}); 

    -> 컬렉션변수에 담겨진 요소를 한씩 자동으로 돌아줌
    -> 이때 2가지의 전달값이 함수내부로 전달됨 
  ...
  *****************************************/
  ...
  /////////////////////////////////////////////////
  //// 햄버거버튼 클릭시 모바일메뉴 보이기 /////////
  //// 대상: 이벤트대상- .hbtn / 변경대상- #mobx ///
  /////////////////////////////////////////////////
  $(".hbtn").click(() => {
    $("#mobx").slideToggle(400, "easeInCirc");
    // slideToggle()은 slideDown/slideUp을 전환함
...
window.addEventListener('scroll', () => {
  ...
  */
  ...
  /* if (scTop >= scPos[0] - winH &&
    scTop < scPos[0])
    scAct[0].classList.add("on");

  else if (scTop >= scPos[1] - winH &&
    scTop < scPos[1])
